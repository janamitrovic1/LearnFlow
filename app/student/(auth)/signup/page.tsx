      ...
      <div className="w-full max-w-4xl bg-gray-800 rounded-xl shadow-xl overflow-hidden flex">
        ...
        <div className="hidden md:flex md:w-1/2 bg-[#252641] items-center justify-center p-8">
          <div className="text-center">
            ...
            <p className="text-gray-300">Sign up to unlock your full potential as a student.</p>
          </div>
        </div>
  
        {/* Desna strana sa formom */}
        <div className="w-full md:w-1/2 p-8">
          <h2 className="text-3xl font-semibold mb-4">Sign Up As a Student</h2>
          {error?.request && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <p className="text-center text-sm text-gray-400">
              ...
              <Link href="/student/signin" className="text-[#767BC4] hover:underline">
                Sign In!
              </Link>
            </p>
          </form>
