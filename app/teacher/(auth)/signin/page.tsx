	...
	<div className="min-h-screen flex justify-center items-center bg-gray-900 text-white">
	  <div className="w-full max-w-4xl bg-gray-800 rounded-xl shadow-xl overflow-hidden flex">
		...
		<div className="w-full md:w-1/2 p-8">
		  <h2 className="text-3xl font-semibold mb-4">Sign In As a Teacher</h2>
		  {error?.request && (
		  ...
		  <form onSubmit={handleSubmit} className="space-y-6">
			{["email", "password"].map((field) => (
			  <div key={field}>
				...
				<input
				  ...
				  className="w-full px-4 py-2 border border-gray-700 bg-gray-900 text-gray-200 rounded-lg focus:ring-[#767BC4] focus:border-[#767BC4]"
				/>
			...
			<p className="text-center text-sm text-gray-400">
			  ...
			  <Link href="/teacher/signup" className="text-[#767BC4] hover:underline">
				Sign Up!
			  </Link>
			</p>
		  </form>
